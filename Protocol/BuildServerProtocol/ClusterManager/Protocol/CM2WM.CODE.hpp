...
namespace ClusterManager { namespace WorldManager { namespace Protocol { class CM2WM; } } }
const uint32 engine::id<ClusterManager::WorldManager::Protocol::CM2WM>::value = 0x13000000;
#endif