...
namespace Message.Gate.ClusterManager.Protocol.G2CM {
	...
	public class Api {
		static public void GenerateId() {
			Engine.Foundation.Id<Message.Gate.ClusterManager.Protocol.G2CM.MSG_G2CM_Heartbeat>.Value = 0x21000001;
			Engine.Foundation.Id<Message.Gate.ClusterManager.Protocol.G2CM.MSG_G2CM_Register>.Value = 0x21000002;
		}
	}
