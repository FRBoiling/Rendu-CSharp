...
const uint32 engine::id<Message::Gate::ClusterManager::Protocol::G2CM::MSG_W2CM_Heartbeat>::value = 0x21000001;
const uint32 engine::id<Message::Gate::ClusterManager::Protocol::G2CM::MSG_W2CM_Register>::value = 0x21000002;
