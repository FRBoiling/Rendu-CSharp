...
namespace Entitas.Group
{
    ...
    public class Group<TEntity> : IGroup<TEntity> where TEntity : class, IEntity
    {
        ...
        public void UpdateEntity(TEntity entity, int index, IComponent previousComponent, IComponent newComponent)
        {
            ...
            {
                if (OnEntityRemoved != null) OnEntityRemoved(this, entity, index, previousComponent);
                if (OnEntityAdded != null) OnEntityAdded(this, entity, index, newComponent);
        ...
        {
            if (addEntitySilently(entity) && OnEntityAdded != null) OnEntityAdded(this, entity, index, component);
        }
        ...
        private void removeEntity(TEntity entity, int index, IComponent component)
        {
            ...
            if (removed)
            {
                _entitiesCache = null;
                _singleEntityCache = null;
                if (OnEntityRemoved != null) OnEntityRemoved(this, entity, index, component);
                entity.Release(this);
            }
        }
        ...
        {
            if (_toStringCache == null) _toStringCache = "Group(" + matcher + ")";
