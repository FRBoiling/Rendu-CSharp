internal class describe_MultiReactiveSystem : nspec
{
    private void when_executing()
    {
        context["when triggered"] = () =>
        {
            ...
            before = () =>
            {
                ...
                {
                    foreach (var e in entities) e.nameAge.age += 10;
                };
            ...
            it["executes once"] = () => { system.didExecute.should_be(1); };

            it["retains once even when multiple collectors contain entity"] = () => { system.didExecute.should_be(1); };

            it["can ToString"] = () => { system.ToString().should_be("MultiReactiveSystem(MultiReactiveSystemSpy)"); };
        };
        ...
        context["when multiple collectors are triggered with same entity"] = () =>
        {
            ...
            it["merges collected entities and removes duplicates"] = () => { system.entities.Length.should_be(1); };
