...
internal class describe_EntityIndex : nspec
{
    private void when_primary_index()
    {
        context["single key"] = () =>
        {
            ...
            {
                it["returns null when getting entity for unknown key"] = () => { index.GetEntity("unknownKey").should_be_null(); };
            };
            ...
            context["when entity for key exists"] = () =>
            {
                ...
                it["gets entity for key"] = () => { index.GetEntity(name).should_be_same(entity); };
                ...
                it["can ToString"] = () => { index.ToString().should_be("PrimaryEntityIndex(TestIndex)"); };

                context["when deactivated"] = () =>
                {
                    before = () => { index.Deactivate(); };
                    ...
                    {
                        before = () => { index.Activate(); };

                        it["has existing entity"] = () => { index.GetEntity(name).should_be_same(entity); };
        ...
        context["multiple keys"] = () =>
        {
            ...
            context["when entity for key exists"] = () =>
            {
                ...
                it["retains entity"] = () =>
                {
                    ...
                    if (safeAerc != null) safeAerc.owners.should_contain(index);
                };
                ...
                it["releases and removes entity from index when component gets removed"] = () =>
                {
                    ...
                    var safeAerc = entity.aerc as SafeAERC;
                    if (safeAerc != null) safeAerc.owners.should_not_contain(index);
                };
    ...
    private void when_index()
    {
        context["single key"] = () =>
        {
            ...
            context["when entity for key doesn't exist"] = () => { it["has no entities"] = () => { index.GetEntities("unknownKey").should_be_empty(); }; };
            ...
            context["when entity for key exists"] = () =>
            {
                ...
                it["can ToString"] = () => { index.ToString().should_be("EntityIndex(TestIndex)"); };
        ...
        context["multiple keys"] = () =>
        {
            ...
            context["when entity for key exists"] = () =>
            {
                ...
                it["retains entity"] = () =>
                {
                    ...
                    if (safeAerc1 != null) safeAerc1.owners.should_contain(index);

                    var safeAerc2 = entity1.aerc as SafeAERC;
                    if (safeAerc2 != null) safeAerc2.owners.should_contain(index);
                };
                ...
                it["releases and removes entity from index when component gets removed"] = () =>
                {
                    ...
                    var safeAerc1 = entity1.aerc as SafeAERC;
                    if (safeAerc1 != null) safeAerc1.owners.should_not_contain(index);
    ...
    private void when_index_multiple_components()
    {
#pragma warning disable
        ...
        it["works with NoneOf"] = () =>
        {
            ...
            index = new EntityIndex<TestEntity, string>("TestIndex", group, (e, c) =>
            {
                ...
                if (c == nameAgeComponent1) return ((NameAgeComponent) c).name;
