...
internal class describe_Entity : nspec
{
    ...
    private void assertHasComponentA(TestEntity e, IComponent componentA = null)
    {
        if (componentA == null) componentA = Component.A;
    ...
    private void assertHasNotComponentA(TestEntity e)
    {
        var components = e.GetComponents();
    ...
    private void when_created()
    {
        TestEntity e = null;
        before = () => { e = this.CreateEntity(); };
        ...
        context["initial state"] = () =>
        {
            it["has default ContextInfo"] = () =>
            {
                ...
                for (var i = 0; i < e.contextInfo.componentNames.Length; i++) e.contextInfo.componentNames[i].should_be(i.ToString());
            };
            ...
            it["throws when attempting to get component at index which hasn't been added"] = expect<EntityDoesNotHaveComponentException>(() => { e.GetComponentA(); });

            it["gets total components count when empty"] = () => { e.totalComponents.should_be(CID.TotalComponents); };

            it["gets empty array of components when no components were added"] = () => { e.GetComponents().should_be_empty(); };

            it["gets empty array of component indices when no components were added"] = () => { e.GetComponentIndices().should_be_empty(); };

            it["doesn't have component at index when no component was added"] = () => { e.HasComponentA().should_be_false(); };

            it["doesn't have components at indices when no components were added"] = () => { e.HasComponents(_indicesA).should_be_false(); };

            it["doesn't have any components at indices when no components were added"] = () => { e.HasAnyComponent(_indicesA).should_be_false(); };
            ...
            it["throws when attempting to remove a component at index which hasn't been added"] = expect<EntityDoesNotHaveComponentException>(() => { e.RemoveComponentA(); });
        ...
        {
            before = () => { e.AddComponentA(); };

            it["throws when adding a component at the same index twice"] = expect<EntityAlreadyHasComponentException>(() => { e.AddComponentA(); });
            ...
            it["doesn't have components at indices when not all components were added"] = () => { e.HasComponents(_indicesAB).should_be_false(); };

            it["has any components at indices when any component was added"] = () => { e.HasAnyComponent(_indicesAB).should_be_true(); };

            context["when adding another component"] = () =>
            {
                before = () => { e.AddComponentB(); };
                ...
                it["has other component"] = () => { e.HasComponentB().should_be_true(); };

                it["has components at indices when all components were added"] = () => { e.HasComponents(_indicesAB).should_be_true(); };
        ...
        context["componentPool"] = () =>
        {
            ...
            it["gets same component context instance"] = () => { e.GetComponentPool(CID.ComponentA).should_be_same(e.GetComponentPool(CID.ComponentA)); };
        ...
        context["reference counting"] = () =>
        {
            it["retains entity"] = () =>
            {
                ...
                if (safeAerc != null) safeAerc.owners.should_contain(this);
            };
            ...
            it["releases entity"] = () =>
            {
                ...
                var safeAerc = e.aerc as SafeAERC;
                if (safeAerc != null) safeAerc.owners.should_not_contain(this);
            };
        ...
        context["internal caching"] = () =>
        {
            context["components"] = () =>
            {
                ...
                it["caches components"] = () => { e.GetComponents().should_be_same(cache); };
            ...
            context["component indices"] = () =>
            {
                ...
                it["caches component indices"] = () => { e.GetComponentIndices().should_be_same(cache); };
            ...
            context["ToString"] = () =>
            {
                context["when component was added"] = () =>
                {
                    ...
                    it["caches entity description"] = () => { e.ToString().should_be_same(cache); };
                    ...
                    it["released entity doesn't have updated cache"] = () =>
                    {
                        e.Retain(this);
                        cache = e.ToString();
                        e.OnEntityReleased += entity => { e.ToString().should_be_same(cache); };
                        e.Release(this);
                    };
