...
internal class describe_Collector : nspec
{
    private IContext<TestEntity> _context;
    ...
    private void when_created()
    {
        ...
        {
            before = () => { collectorA = new Collector<TestEntity>(groupA, GroupEvent.Added); };

            it["is empty when nothing happend"] = () => { collectorA.collectedEntities.should_be_empty(); };
            ...
            context["when entity collected"] = () =>
            {
                ...
                it["can ToString"] = () => { collectorA.ToString().should_be("Collector(Group(AllOf(1)))"); };
            };
            ...
            context["reference counting"] = () =>
            {
                ...
                it["retains entity even after destroy"] = () =>
                {
                    ...
                    if (safeAerc != null) safeAerc.owners.should_contain(collectorA);
        ...
        {
            before = () => { collectorA = new Collector<TestEntity>(groupA, GroupEvent.Removed); };
        ...
        {
            before = () => { collectorA = new Collector<TestEntity>(groupA, GroupEvent.AddedOrRemoved); };
        ...
        context["when observing multiple groups"] = () =>
        {
            ...
            before = () => { groupB = _context.GetGroup(Matcher<TestEntity>.AllOf(CID.ComponentB)); };
            ...
            context["when observing with GroupEvent.Added"] = () =>
            {
                ...
                it["can ToString"] = () => { collectorA.ToString().should_be("Collector(Group(AllOf(1)), Group(AllOf(2)))"); };
            };
    ...
    private TestEntity createEA()
    {
        return _context.CreateEntity().AddComponentA();
    }

    private TestEntity createEB()
    {
