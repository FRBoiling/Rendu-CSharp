...
internal class describe_Matcher : nspec
{
    private static void assertIndicesContain(int[] indices, params int[] expectedIndices)
    {
        ...
        for (var i = 0; i < expectedIndices.Length; i++) indices[i].should_be(expectedIndices[i]);
    }

    private void when_creating_matcher()
    {
        TestEntity eA = null;
        TestEntity eB = null;
        TestEntity eC = null;
        ...
        context["allOf"] = () =>
        {
            ...
            {
                m = Matcher<TestEntity>.AllOf(CID.ComponentA, CID.ComponentA, CID.ComponentB, CID.ComponentB);
                assertIndicesContain(m.indices, CID.ComponentA, CID.ComponentB);
                assertIndicesContain(m.allOfIndices, CID.ComponentA, CID.ComponentB);
            };
        ...
        context["anyOf"] = () =>
        {
            ...
            before = () => m = Matcher<TestEntity>.AnyOf(CID.ComponentA, CID.ComponentB);

            it["has all indices"] = () =>
            {
                m = Matcher<TestEntity>.AnyOf(CID.ComponentA, CID.ComponentB);
                assertIndicesContain(m.indices, CID.ComponentA, CID.ComponentB);
            ...
            it["has all indices without duplicates"] = () =>
            {
                m = Matcher<TestEntity>.AnyOf(CID.ComponentA, CID.ComponentA, CID.ComponentB, CID.ComponentB);
                assertIndicesContain(m.indices, CID.ComponentA, CID.ComponentB);
                assertIndicesContain(m.anyOfIndices, CID.ComponentA, CID.ComponentB);
            };
        ...
        context["allOf.noneOf"] = () =>
        {
            ...
            before = () => m = Matcher<TestEntity>.AllOf(CID.ComponentA, CID.ComponentB).NoneOf(CID.ComponentC, CID.ComponentD);
            ...
            it["has all indices without duplicates"] = () =>
            {
                m = Matcher<TestEntity>.AllOf(CID.ComponentA, CID.ComponentA, CID.ComponentB).NoneOf(CID.ComponentB, CID.ComponentC, CID.ComponentC);
        ...
        context["anyOf.noneOf"] = () =>
        {
            ...
            before = () => m = Matcher<TestEntity>.AnyOf(CID.ComponentA, CID.ComponentB).NoneOf(CID.ComponentC, CID.ComponentD);
            ...
            it["has all indices without duplicates"] = () =>
            {
                m = Matcher<TestEntity>.AnyOf(CID.ComponentA, CID.ComponentA, CID.ComponentB).NoneOf(CID.ComponentB, CID.ComponentC, CID.ComponentC);
                assertIndicesContain(m.indices, CID.ComponentA, CID.ComponentB, CID.ComponentC);
                assertIndicesContain(m.anyOfIndices, CID.ComponentA, CID.ComponentB);
                assertIndicesContain(m.noneOfIndices, CID.ComponentB, CID.ComponentC);
            };
        ...
        context["allOf.anyOf"] = () =>
        {
            ...
            before = () => m = Matcher<TestEntity>.AllOf(CID.ComponentA, CID.ComponentB).AnyOf(CID.ComponentC, CID.ComponentD);
            ...
            it["has all indices without duplicates"] = () =>
            {
                m = Matcher<TestEntity>.AllOf(CID.ComponentA, CID.ComponentA, CID.ComponentB).AnyOf(CID.ComponentB, CID.ComponentC, CID.ComponentC);
                assertIndicesContain(m.indices, CID.ComponentA, CID.ComponentB, CID.ComponentC);
                assertIndicesContain(m.allOfIndices, CID.ComponentA, CID.ComponentB);
