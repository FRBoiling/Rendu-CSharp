...
internal class describe_EntitasErrorMessages : nspec
{
    private static void printErrorMessage(Action action)
    {
        try
        {
            action();
    ...
    private void when_throwing()
    {
        ...
        context["Entity"] = () =>
        {
            ...
            context["when enabled"] = () =>
            {
                ...
                it["remove a component that doesn't exist"] = () => printErrorMessage(() => { entity.RemoveComponentA(); });

                it["get a component that doesn't exist"] = () => printErrorMessage(() => { entity.GetComponentA(); });
        ...
        context["Context"] = () =>
        {
            ...
            it["releases entity before destroy"] = () => printErrorMessage(() => { entity.Release(ctx); });

            it["unknown entityIndex"] = () => printErrorMessage(() => { ctx.GetEntityIndex("unknown"); });
        ...
        context["CollectionExtension"] = () => { it["get single entity when more than one exist"] = () => printErrorMessage(() => { new IEntity[2].SingleEntity(); }); };
