...
internal class describe_Systems : nspec
{
    ...
    private void when_systems()
    {
        ...
        context["systems"] = () =>
        {
            ...
            before = () => { systems = new Systems(); };

            it["returns systems when adding system"] = () => { systems.Add(new InitializeSystemSpy()).should_be_same(systems); };
