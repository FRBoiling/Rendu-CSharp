...
{   
    ...
    {
        var typeName = Rd.Utils.SerializationTypeExtension.ToCompilableString(GetType());
        var shortType = Rd.Utils.SerializationTypeExtension.ShortTypeName(typeName);
        var readableType = Rd.Utils.StringExtension.ToSpacedCamelCase(shortType);
...
public class Feature : Entitas.Systems
{
    ...
    {   }
        ...
        public CodeGenFile[] Generate(CodeGeneratorData[] data)
        {
            ...
            {
                new CodeGenFile("Feature.cs", FEATURE_TEMPLATE,this.GetType().FullName)
            };
        }
