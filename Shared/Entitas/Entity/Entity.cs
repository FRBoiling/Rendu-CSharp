...
namespace Entitas
{
    ...
    public class Entity : IEntity
    {
        ...
        public void AddComponent(int index, IComponent component)
        {
            ...
            _toStringCache = null;
            if (OnComponentAdded != null) OnComponentAdded(this, index, component);
        }
        ...
        public void ReplaceComponent(int index, IComponent component)
        {
            ...
            else if (component != null) AddComponent(index, component);
        }
        ...
        public IComponent[] GetComponents()
        {
            if (_componentsCache == null)
            {
                for (var i = 0; i < _components.Length; i++)
                {
                    ...
                    if (component != null) _componentBuffer.Add(component);
                }
        ...
        public int retainCount => aerc.retainCount;
        ...
        public void Destroy()
        {
            if (!isEnabled) throw new EntityIsNotEnabledException("Cannot destroy " + this + "!");

            if (OnDestroyEntity != null) OnDestroyEntity(this);
        }
        ...
        private ContextInfo createDefaultContextInfo()
        {
            ...
            for (var i = 0; i < componentNames.Length; i++) componentNames[i] = i.ToString();
        ...
        private void replaceComponent(int index, IComponent replacement)
        {
            ...
            if (replacement != previousComponent)
            {
                ...
                else
                {
                    ...
                    if (OnComponentRemoved != null) OnComponentRemoved(this, index, previousComponent);
                }
...
//                    );
                    ...
                    if (i < lastSeparator) _toStringBuilder.Append(separator);
                }
