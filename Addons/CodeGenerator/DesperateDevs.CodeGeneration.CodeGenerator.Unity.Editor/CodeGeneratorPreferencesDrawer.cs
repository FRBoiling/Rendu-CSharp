...
namespace DesperateDevs.CodeGeneration.CodeGenerator.Unity.Editor
{
  public class CodeGeneratorPreferencesDrawer : AbstractPreferencesDrawer
  {
    ...
    private const string USE_EXTERNAL_CODE_GENERATOR = "DesperateDevs.CodeGeneration.CodeGenerator.Unity.Editor.UseExternalCodeGenerator";
    ...
    public override void Initialize(Preferences preferences)
    {
      ...
      this._useExternalCodeGenerator = EditorPrefs.GetBool("DesperateDevs.CodeGeneration.CodeGenerator.Unity.Editor.UseExternalCodeGenerator");
      this._doDryRun = EditorPrefs.GetBool("DesperateDevs.CodeGeneration.CodeGenerator.Unity.Editor.DryRun", true);
    }
    ...
    protected override void drawContent(Preferences preferences)
    {
      ...
      {
        EditorPrefs.SetString("DesperateDevs.CodeGeneration.CodeGenerator.Unity.Editor.PropertiesPath", str);
        EditorWindow.focusedWindow.Close();
...
//      this._useExternalCodeGenerator = EditorGUILayout.Toggle("Use Jenny Server", this._useExternalCodeGenerator);
      if (EditorGUI.EndChangeCheck())
        EditorPrefs.SetBool("DesperateDevs.CodeGeneration.CodeGenerator.Unity.Editor.UseExternalCodeGenerator", this._useExternalCodeGenerator);
      ...
      else
      {
        ...
        if (EditorGUI.EndChangeCheck())
          EditorPrefs.SetBool("DesperateDevs.CodeGeneration.CodeGenerator.Unity.Editor.DryRun", this._doDryRun);
      }
