...
using UnityEditor;
using UnityEngine;
using SystemInfo = Rendu.VisualDebugging.Unity.DebugSystems.SystemInfo;

namespace Rendu.VisualDebugging.Unity.Editor.DebugSystems
{
    ...
    public class DebugSystemsInspector : UnityEditor.Editor
    {
        ...
        static void drawSystemsOverview(Unity.DebugSystems.DebugSystems systems)
        {
        ...
        void drawSystemsMonitor(Unity.DebugSystems.DebugSystems systems)
        {
        ...
        void drawSystemList(Unity.DebugSystems.DebugSystems systems)
        {
            ...
            if (_showSystemsList)
            {
                EditorLayout.BeginSectionContent();
                {
                    EditorGUILayout.BeginHorizontal();
                    {
                        Unity.DebugSystems.DebugSystems.avgResetInterval = (AvgResetInterval)EditorGUILayout.EnumPopup("Reset average duration Ø", Unity.DebugSystems.DebugSystems.avgResetInterval);
        ...
        int drawSystemInfos(Unity.DebugSystems.DebugSystems systems, SystemInterfaceFlags type)
        {
            ...
            {
                var debugSystems = systemInfo.system as Unity.DebugSystems.DebugSystems;
                ...
                var debugSystem = systemInfo.system as Unity.DebugSystems.DebugSystems;
                if (debugSystem != null)
                {
                    var indent = EditorGUI.indentLevel;
        ...
        static bool shouldShowSystems(Unity.DebugSystems.DebugSystems systems, SystemInterfaceFlags type)
        {
