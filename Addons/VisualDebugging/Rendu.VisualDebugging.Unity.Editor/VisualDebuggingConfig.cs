...
namespace Rendu.VisualDebugging.Unity.Editor {
    ...
    public class VisualDebuggingConfig : AbstractConfigurableConfig {
        ...
        const string SYSTEM_WARNING_THRESHOLD_KEY = "Rendu.VisualDebugging.Unity.Editor.SystemWarningThreshold";
        const string DEFAULT_INSTANCE_CREATOR_FOLDER_PATH_KEY = "Rendu.VisualDebugging.Unity.Editor.DefaultInstanceCreatorFolderPath";
        const string TYPE_DRAWER_FOLDER_PATH_KEY = "Rendu.VisualDebugging.Unity.Editor.TypeDrawerFolderPath";
