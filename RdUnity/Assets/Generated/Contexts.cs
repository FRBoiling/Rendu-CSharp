...
public partial class Contexts : Entitas.IContexts {
    ...
    public Entitas.IContext[] allContexts { get { return new Entitas.IContext [] { game, test }; } }
...
public partial class Contexts {
    ...
    public void InitializeEntityIndices() {
        ...
        test.AddEntityIndex(new Entitas<TestEntity, string>(
            Player,
            test.GetGroup(TestMatcher.Player),
            (e, c) => ((PlayerComponent)c).name));
    }
}
...
public static class ContextsExtensions {
    ...
    public static System.Collections.Generic.HashSet<TestEntity> GetEntitiesWithPlayer(this TestContext context, string name) {
        return ((Entitas<TestEntity, string>)context.GetEntityIndex(Contexts.Player)).GetEntities(name);
    }
}
//------------------------------------------------------------------------------
// <auto-generated>
